...
export class NFLPlayer {
    ...
    constructor(source: any = {}) {
        ...
        this.SeasonStats = this.convertValues(source["SeasonStats"], NFLPlayerSeasonStats);
        this.Contract = this.convertValues(source["Contract"], NFLContract);
        this.Offers = this.convertValues(source["Offers"], FreeAgencyOffer);
        this.WaiverOffers = this.convertValues(source["WaiverOffers"], NFLWaiverOffer);
        this.Extensions = this.convertValues(source["Extensions"], NFLExtensionOffer);
    }
...
export class NFLDepthChart {
    ...
    constructor(source: any = {}) {
        ...
        this.DeletedAt = this.convertValues(source["DeletedAt"], Time);
        this.TeamID = source["TeamID"];
        this.DepthChartPlayers = this.convertValues(source["DepthChartPlayers"], NFLDepthChartPosition);
    }
...
export class NFLTeamSeasonStats {
    ...
    constructor(source: any = {}) {
        ...
        this.RushingYardsPerAttemptAllowed = source["RushingYardsPerAttemptAllowed"];
        this.SoloTackles = source["SoloTackles"];
        this.AssistedTackles = source["AssistedTackles"];
        this.TacklesForLoss = source["TacklesForLoss"];
...
export class NFLTeam {
    ...
    constructor(source: any = {}) {
        ...
        this.TeamSeasonStats = this.convertValues(source["TeamSeasonStats"], NFLTeamSeasonStats);
        this.TeamDepthChart = this.convertValues(source["TeamDepthChart"], NFLDepthChart);
...
export class CollegeTeamDepthChart {
    ...
    constructor(source: any = {}) {
        ...
        this.DeletedAt = this.convertValues(source["DeletedAt"], Time);
        this.TeamID = source["TeamID"];
        this.DepthChartPlayers = this.convertValues(source["DepthChartPlayers"], CollegeDepthChartPosition);
    }
...
export class CollegeCoach {
    ...
    constructor(source: any = {}) {
        ...
        this.OverallConferenceChampionships = source["OverallConferenceChampionships"];
...
export class CollegeTeam {
    ...
    constructor(source: any = {}) {
        ...
        this.RecruitingProfile = this.convertValues(source["RecruitingProfile"], RecruitingTeamProfile);
        this.TeamStats = this.convertValues(source["TeamStats"], CollegeTeamStats);
        this.TeamSeasonStats = this.convertValues(source["TeamSeasonStats"], CollegeTeamSeasonStats);
        this.TeamRecord = this.convertValues(source["TeamRecord"], CollegeTeamRecords);
        this.TeamGameplan = this.convertValues(source["TeamGameplan"], CollegeGameplan);
        this.TeamDepthChart = this.convertValues(source["TeamDepthChart"], CollegeTeamDepthChart);
        this.TeamStandings = this.convertValues(source["TeamStandings"], CollegeStandings);
    }
...
export class BootstrapData {
    ...
    constructor(source: any = {}) {
        ...
        this.CollegeGameplan = this.convertValues(source["CollegeGameplan"], CollegeGameplan);
        this.CollegeDepthChart = this.convertValues(source["CollegeDepthChart"], CollegeTeamDepthChart);
...
export class BootstrapDataTwo {
    CollegeNews: NewsLog[];
    AllCollegeGames: CollegeGame[];
    TeamProfileMap: {[key: string]: RecruitingTeamProfile};
    CollegeStandings: CollegeStandings[];
    ProStandings: NFLStandings[];
    AllProGames: NFLGame[];
    CapsheetMap: {[key: uint]: NFLCapsheet};
    ProRosterMap: {[key: uint]: NFLPlayer[]};
    ...
    constructor(source: any = {}) {
        ...
        this.CapsheetMap = this.convertValues(source["CapsheetMap"], NFLCapsheet, true);
        this.ProRosterMap = source["ProRosterMap"];
        this.PracticeSquadPlayers = this.convertValues(source["PracticeSquadPlayers"], NFLPlayer);
...
export class BootstrapDataThree {
    ...
    CollegeDepthChartMap: {[key: uint]: CollegeTeamDepthChart};
    ...
    ExtensionMap: {[key: uint]: NFLExtensionOffer};
    ...
    constructor(source: any = {}) {
        ...
        this.CollegeDepthChartMap = this.convertValues(source["CollegeDepthChartMap"], CollegeTeamDepthChart, true);
...
export class CollegeTeamProfileData {
    ...
    PlayerMap: {[key: uint]: CollegePlayer};
    CollegeGames: CollegeGame[];

    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.CareerStats = this.convertValues(source["CareerStats"], CollegePlayerSeasonStats);
        this.CollegeStandings = this.convertValues(source["CollegeStandings"], CollegeStandings);
        this.Rivalries = this.convertValues(source["Rivalries"], FlexComparisonModel);
        this.PlayerMap = this.convertValues(source["PlayerMap"], CollegePlayer, true);
...
export class SearchStatsResponse {
    ...
    constructor(source: any = {}) {
        ...
        this.CFBPlayerSeasonStats = this.convertValues(source["CFBPlayerSeasonStats"], CollegePlayerSeasonStats);
        this.CFBTeamGameStats = this.convertValues(source["CFBTeamGameStats"], CollegeTeamStats);
        this.CFBTeamSeasonStats = this.convertValues(source["CFBTeamSeasonStats"], CollegeTeamSeasonStats);
        this.NFLPlayerGameStats = this.convertValues(source["NFLPlayerGameStats"], NFLPlayerStats);
        this.NFLPlayerSeasonStats = this.convertValues(source["NFLPlayerSeasonStats"], NFLPlayerSeasonStats);
        this.NFLTeamGameStats = this.convertValues(source["NFLTeamGameStats"], NFLTeamStats);
        this.NFLTeamSeasonStats = this.convertValues(source["NFLTeamSeasonStats"], NFLTeamSeasonStats);
    }
...
export class TeamRequestsResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.CollegeRequests = this.convertValues(source["CollegeRequests"], TeamRequest);
...
export class TransferPortalProfileResponse {
    ...
    constructor(source: any = {}) {
        ...
        this.IsSigned = source["IsSigned"];
        this.Recruiter = source["Recruiter"];
        this.CollegePlayer = this.convertValues(source["CollegePlayer"], TransferPlayerResponse);
        this.Promise = this.convertValues(source["Promise"], CollegePromise);
    }
...
export class TransferPortalResponse {
    ...
    constructor(source: any = {}) {
        ...
        this.TeamBoard = this.convertValues(source["TeamBoard"], TransferPortalProfileResponse);
        this.TeamPromises = this.convertValues(source["TeamPromises"], CollegePromise);
        this.Players = this.convertValues(source["Players"], TransferPlayerResponse);
...
export class UpdateTransferPortalBoard {
    ...
    constructor(source: any = {}) {
        ...
        this.Players = this.convertValues(source["Players"], TransferPortalProfileResponse);
        this.TeamID = source["TeamID"];
    }
...
export class NFLWarRoom {
    ...
    constructor(source: any = {}) {
        ...
        this.SpentPoints = source["SpentPoints"];
        this.DraftPicks = this.convertValues(source["DraftPicks"], NFLDraftPick);
        this.ScoutProfiles = this.convertValues(source["ScoutProfiles"], ScoutingProfile);
    }
...
export class NFLDraftPageResponse {
    ...
    constructor(source: any = {}) {
        ...
        this.DraftablePlayers = this.convertValues(source["DraftablePlayers"], NFLDraftee);
        this.NFLTeams = this.convertValues(source["NFLTeams"], NFLTeam);
        this.AllDraftPicks = this.convertValues(source["AllDraftPicks"], NFLDraftPick);
...
export class ScoutingDataResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.DrafteeSeasonStats = this.convertValues(source["DrafteeSeasonStats"], CollegePlayerSeasonStats);
        this.TeamStandings = this.convertValues(source["TeamStandings"], CollegeStandings);
    }
...
export class NFLTradeProposal {
    ...
    constructor(source: any = {}) {
        ...
        this.NFLTeamTradeOptions = this.convertValues(source["NFLTeamTradeOptions"], NFLTradeOption);
        this.RecepientTeamTradeOptions = this.convertValues(source["RecepientTeamTradeOptions"], NFLTradeOption);
    }
...
export class NFLTradeProposalDTO {
    ...
    constructor(source: any = {}) {
        ...
        this.IsTradeAccepted = source["IsTradeAccepted"];
        this.IsTradeRejected = source["IsTradeRejected"];
        this.NFLTeamTradeOptions = this.convertValues(source["NFLTeamTradeOptions"], NFLTradeOptionObj);
        this.RecepientTeamTradeOptions = this.convertValues(source["RecepientTeamTradeOptions"], NFLTradeOptionObj);
    }
...
export class NFLTeamProposals {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.SentTradeProposals = this.convertValues(source["SentTradeProposals"], NFLTradeProposalDTO);
        this.ReceivedTradeProposals = this.convertValues(source["ReceivedTradeProposals"], NFLTradeProposalDTO);
    }
...
export class GameResultsResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.HomePlayers = this.convertValues(source["HomePlayers"], GameResultsPlayer);
        this.AwayPlayers = this.convertValues(source["AwayPlayers"], GameResultsPlayer);
        this.PlayByPlays = this.convertValues(source["PlayByPlays"], PlayByPlayResponse);
...
export class InboxResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.CFBNotifications = this.convertValues(source["CFBNotifications"], Notification);
        this.NFLNotifications = this.convertValues(source["NFLNotifications"], Notification);
    }

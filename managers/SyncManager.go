...
func getFitsByScheme(scheme string, isBadFit bool) []string {
	fullMap := map[string]structs.SchemeFits{
		...
		"2-Gap Zone":                      {GoodFits: []string{"Run Stopper DE", "Nose Tackle DT", "Run Stopper OLB", "Pass Rush OLB", "Run Stopper ILB", "Zone Coverage CB", "Zone Coverage FS", "Zone Coverage SS"}, BadFits: []string{"Speed Rusher DE", "Pass Rusher DT", "Speed OLB", "Speed ILB", "Man Coverage CB", "Man Coverage FS", "Man Coverage SS"}},
		"4-man Front Spread Stopper Zone": {GoodFits: []string{"Speed Rusher DE", "Pass Rusher DT", "Coverage OLB", "Coverage ILB", "Zone Coverage CB", "Zone Coverage FS", "Zone Coverage SS"}, BadFits: []string{"Run Stopper DE", "Nose Tackle DT", "Run Stoppper OLB", "Run Stopper ILB", "Run Stopper FS", "Run Stopper SS", "Man Coverage CB", "Man Coverage FS", "Man Coverage SS"}},
		...
		"Speed Man":                       {GoodFits: []string{"Speed Rusher DE", "Pass Rusher DT", "Coverage OLB", "Speed OLB", "Speed ILB", "Man Coverage CB", "Man Coverage FS", "Man Coverage SS"}, BadFits: []string{"Run Stopper DE", "Nose Tackle DT", "Pass Rush OLB", "Field General ILB", "Zone Coverage CB", "Zone Coverage FS", "Zone Coverage SS"}},
		"Multiple Man":                    {GoodFits: []string{"Run Stopper DE", "Speed OLB", "Speed ILB", "Field General ILB", "Man Coverage CB", "Man Coverage FS", "Man Coverage SS", "Run Stopper FS", "Run Stopper SS"}, BadFits: []string{"Speed Rusher DE", "Pass Rusher DT", "Coverage OLB", "Coverage ILB", "Zone Coverage CB", "Zone Coverage FS", "Zone Coverage SS"}},
	}

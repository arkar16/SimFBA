...
func handleRequests() {
	...
	// myRouter.HandleFunc("/import/simcfb/college/standings", controller.CreateCollegeStandings).Methods("GET")
	...
	// Stats Controls
	myRouter.HandleFunc("/stats/cfb/player/{playerID}/season/{seasonID}/", controller.GetCFBSeasonStatsRecord).Methods("GET")
	...
	myRouter.HandleFunc("/teams/college/assign/grades/", controller.AssignCFBTeamGrades).Methods("GET")

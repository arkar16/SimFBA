...
func handleRequests() {
	...
	myRouter.HandleFunc("/statistics/export/cfb/{seasonID}/{weekID}/{viewType}", controller.GetStatsPageContentForSeason).Methods("GET")
	myRouter.HandleFunc("/statistics/export/nfl/{seasonID}/{weekID}/{viewType}", controller.GetNFLStatsPageContent).Methods("GET")
